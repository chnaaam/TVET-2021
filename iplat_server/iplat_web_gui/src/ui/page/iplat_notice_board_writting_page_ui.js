...
function IPlatNoticeBoardWrittingPageUI(props){
    return (
        <div style={{
            ...
            <div className={"board-write-area"}
                 style={{
                     width: props.width, height: "900px", minWidth: "1700px",
                     minHeight: "900px", display: "flex", flexDirection: "col",
                ...
                <div style={{ width: "70%",}}>
                    ...
                    <div style={{
                        width: "200px", height: "50px", lineHeight: "50px",
                        color: "gold", fontWeight: "bold", fontSize: "16px",
                    ...
                    <div style={{ width: "100%", height: "50px", lineHeight: "50px", fontSize: "16px", }}>
                        ...
                        <input
                            style={{
                                ...
                                color: "white", outlineStyle: "none",
                                borderRadius: "0px 0px", border: "none", padding: "0px 15px"}}
                            type={'text'}
                ...
                <div style={{ marginTop: "30px", width: "70%", height: "600px",}}>
                    ...
                    <div style={{ width: "100%", height: "50px"}}>
                        ...
                        <div style={{
                            paddingTop:"20px", float:"right", display:"inline-block",
...
export default IPlatNoticeBoardWrittingPageUI;
